...
<div class="hero-wrap hero-bread" style="background-image: url('frontend/images/art2.jpeg');">
	<div class="container">
				...
				<div class="cart-list">
					<table class="table">
						...
						<tbody>
							...
							@php $total += $product['product_price'] * $product['qty'] @endphp

							<tr class="text-center">
								<td class="product-remove "><a href="/removeItem/{{$product['product_id']}}"><span
								...
								{!!Form::open(['action'=> 'App\Http\Controllers\ClientController@updateqty',
								...
								<td class="quantity">
									<div class="input-group mb-3">
										...
										<input type="hidden" name="id" class="quantity form-control input-number"
